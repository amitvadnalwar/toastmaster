...
export default function RegisterMemberPage() {
  ...
  // Already logged in — nothing to register, same guard as the login page.
    ...
    <div className="flex flex-col min-h-full bg-gray-50">
      <div className="bg-white border-b border-gray-100 px-4 py-3 sticky top-0 z-20">
        <div className="max-w-lg mx-auto flex items-center justify-between">
          <button onClick={() => navigate('/login')} className="flex items-center text-brand font-semibold text-base w-[70px]">
            <ChevronLeft size={20} /> Cancel
          </button>
          <h1 className="text-lg font-bold text-gray-900">Register as Member</h1>
