    ...
    <div className="flex flex-col min-h-full bg-gray-50">
      ...
      {loading ? (
        ...
        <div className="flex-1 overflow-y-auto px-5 pt-6 pb-28 max-w-lg mx-auto w-full">
          ...
          <button onClick={handleSignOut} disabled={signingOut} className="w-full border border-red-300 bg-white rounded-xl py-3.5 text-[15px] font-semibold text-red-500 active:bg-red-50">
